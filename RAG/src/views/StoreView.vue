...
.main {
  ...
  display: flex; /* 使用 flex 布局来垂直居中内容 */
...
.file-boxs-grid {
  ...
  max-width: 600px; /* 假设 FileBox 宽度 approx 280px * 2 + 30px gap */
  width: 100%; /* 确保在 max-width 范围内占据可用宽度 */
  justify-content: center; /* 如果列数不足，内容居中 */
}

.pagination-controls-container {
  margin-top: 30px; /* 与文件网格的间距 */
  margin-bottom: 30px; /* 与下方按钮的间距 */
  width: 100%;
  display: flex;
  justify-content: center; /* 使分页组件本身居中 */
}
